...
pub impl GameCreatedImpl of GameCreatedTrait {
    fn new(
        game_id: felt252, player: ContractAddress, settings_id: u32, seed: felt252,
    ) -> GameCreated {
...
pub impl GrimoireCompletedImpl of GrimoireCompletedTrait {
    fn new(game_id: felt252, player: ContractAddress, completion_time: u64) -> GrimoireCompleted {
