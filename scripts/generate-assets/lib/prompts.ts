...
export function buildWorldMapPrompt(): string {
  return [
    ...
    `Five distinct biome zones arranged LEFT-TO-RIGHT in the CENTER of the image, occupying the central 80% of the width and 50% of the height:`,
    `ZONE 1: Amber Hollows — warm golden cavern openings, amber-tinted rock formations, copper veins in stone, soft golden light filtering through. Earthy and inviting.`,
    `ZONE 2: Ember Cavern — volcanic fissures, smoldering dragon-fire residue, sulfur crystal formations, dark stone with orange-red magma glow. Dangerous and fiery.`,
    `ZONE 3: Aether Spire — ethereal purple floating platforms with a central arcane tower, swirling energy trails, glowing rune circles, starlit purple atmosphere.`,
    `ZONE 4: Sunken Abyss — deep underwater cavern, bioluminescent blue cave pearls, dripping stalactites, dark river channels, faint deep-blue glow. Mysterious and oppressive.`,
    `ZONE 5: Crystalveil Reach — crystalline frost forest, emerald gemstone outcrops, frozen flower blooms, teal-green aurora wisps. Alien and beautiful.`,
    `A clearly visible winding path runs horizontally through all five zones from left to right, connecting them in sequence.`,
    ...
    `The five zones are CENTERED in the image — they do NOT touch the edges. Dark wilderness filler surrounds them on all four sides.`,
    GLOBAL_ART_STYLE,
    `Color palette: dark background #080810, golden amber #c8a040 for hollows, burnt orange #b85030 for cavern, purple #9e4a9e for spire, deep blue #2a5a8a for abyss, emerald teal #2a8a6a for crystalveil, dark blacks for surrounding wilderness.`,
